...
\vspace{0.5cm}
{\scshape\Large Institute of Mechanical Systems (IMS)\par}

\vspace{2.5cm}

{\huge\bfseries Betaflight -- Offline Controller Tuning\par}

\vspace{0.5cm}

{\Large Data-Driven Tuning of Rate and Altitude Controllers for FPV Drones\par}
...
\textbf{Authors:} & Yuri Bianchi \\
                  ...
                  & Janick Dort \\
\\
\textbf{Degree Program:} & BSc Mechatronics \& Automation \\
\\
\textbf{Institution:} & ZHAW School of Engineering \\
                      & Institute of Mechanical Systems (IMS) \\
\\
\textbf{Date:} & \today \\
\end{tabular}
