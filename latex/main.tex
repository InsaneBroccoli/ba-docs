...
\begin{figure}[h]
\centering
\includegraphics[width=0.4\linewidth]{body_axes.png}
...
The relationship described by the above equations is visualized in Figure~\ref{fig:motor_mixing}. It shows how throttle and attitude inputs are combined to generate individual motor commands. This process enables precise control of the quadcopter.
