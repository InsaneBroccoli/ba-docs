...
\end{equation}
where $J$ denotes the combined moment of inertia of the motor and the propeller, and $k_t$ is the torque constant. For simplicity, viscous friction and the aerodynamic load torque are neglected, resulting in a linear and tractable model.
...
\frac{k_t}{J L s^2 + J R s + k_t k_e}.
