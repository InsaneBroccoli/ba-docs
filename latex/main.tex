...
The gyro controller is the innermost control loop of the flight controller and directly regulates the angular velocity of the drone. It is responsible for stabilizing the drone's attitude by adjusting the motor speeds based on the measured angular rates from the gyroscope.

\subsection{Betaflight Firmware}

\subsubsection{Angel Mode Controll Loop}
