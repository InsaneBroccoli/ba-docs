...
\subsection{Angle Mode Control Loop}
...
%    \caption{Modified control loop structure with chirp injection before the target angle generation.}
...
\section{Control Loop Calculation}
...
\subsection{Estimation of the Closed-Loop Components}
...
\subsection{Implementation of the Tuning Method}
