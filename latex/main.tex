...
\subsection{Propeller Configuration and Rotation Directions}

A quadcopter consists of four motors arranged symmetrically around the center of mass. Each motor drives a propeller, and the direction of rotation alternates between clockwise (CW) and counterclockwise (CCW), as shown in Fig.~\ref{fig:propeller_directions}.

The propellers rotate in alternating directions, which will be discussed in more detail in the next chapter.

Two common configurations, known as “props in” and “props out”, differ only in the rotation direction of the front propellers. However, both configurations follow the same principle of alternating rotation directions and are therefore equivalent in terms of control.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\linewidth]{Propeller_Config.png}
\caption{Propeller rotation directions for a quadcopter in “props in” and “props out” configuration.}
...
\subsection{Motor Mixing and Control Allocation}
